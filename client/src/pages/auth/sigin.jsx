    ...
    <div className="flex justify-center items-center min-h-screen bg-green-950 text-white p-4">
      <div className="w-96 p-8 rounded-2xl shadow-2xl bg-green-800 border border-green-700">
        ...
        <div className="space-y-5">
          ...
          <button className="w-full bg-green-600 hover:bg-green-500 text-white p-3 rounded-lg font-semibold text-lg shadow-md transition duration-300">Log In</button>
        </div>
        <p className="text-center text-green-400 mt-4 text-sm">Don't have an account? <a href="#" className="text-green-300 underline hover:text-green-200">Sign up</a></p>
      </div>
    </div>
  );
}
