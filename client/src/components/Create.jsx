    ...
    <div className="flex justify-center">
      ...
      <dialog id="task_modal" className="modal">
        <div className="modal-box w-11/12 max-w-2xl bg-gradient-to-b from-blue-900 to-green-900 text-white shadow-lg rounded-xl">
          <h3 className="text-2xl font-bold text-center text-green-300 mb-4">Create New Task</h3>
          
          <div className="space-y-4">
            <div>
              <label className="block text-green-300 text-sm font-medium mb-1">Task Name</label>
              <input 
                type="text" 
                value={taskName} 
            ...
            <div>
              <label className="block text-green-300 text-sm font-medium mb-1">Assign To</label>
              <input 
                type="text" 
                value={assignedTo} 
            ...
            <div>
              <label className="block text-green-300 text-sm font-medium mb-1">Due Date</label>
              <input 
                type="date" 
                value={dueDate} 
          ...
          <div className="modal-action flex justify-end space-x-4 mt-4">
            ...
            <button className="btn bg-green-600 hover:bg-green-500 text-white px-5 py-2 rounded-lg shadow-md transition-all">
              Save Task
            </button>
          </div>
        </div>
